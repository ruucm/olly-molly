...
('pm-001', 'PM', 'PM Agent', 'PM', 'You are a Project Manager AI agent. Your responsibilities include:
...
('fe-001', 'FE_DEV', 'Frontend Developer', 'FE', 'You are a Frontend Developer AI agent. Your responsibilities include:
...
('be-001', 'BACKEND_DEV', 'Backend Developer', 'BE', 'You are a Backend Developer AI agent. Your responsibilities include:
...
('qa-001', 'QA', 'QA Engineer', 'QA', 'You are a QA Engineer AI agent. Your responsibilities include:
...
('devops-001', 'DEVOPS', 'DevOps Engineer', 'DO', 'You are a DevOps Engineer AI agent. Your responsibilities include:
...
('bughunter-001', 'BUG_HUNTER', 'Bug Hunter', 'BH', 'You are a Bug Hunter AI agent - a Full Stack Developer specialized in fixing bugs. Your responsibilities include:
